...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td>
        <p>A conference request has been submitted by <b>{{$formdata["firstname"]}} {{$formdata["lastname"]}}</b> to attend "<b>{{$formdata["confname"]}}</b>". You are listed as the approving manager.<br/>
