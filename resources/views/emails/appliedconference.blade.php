...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td>
        <p>A conference request has been submitted by <b>{{$formdata["firstname"]}} {{$formdata["lastname"]}}</b> to attend "<b>{{$formdata["confname"]}}</b>".<br />
    ...
    <tr>
        <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>Deliverables needed</td>
                    <td>: {{ ($formdata["deliverables"] != '' ? $formdata["deliverables"] : '-') }}</td>
                </tr>
                <tr>
                    <td>Total Travel Cost (inclusive of air travel, lodging, car rental, etc.)</td>
                    <td>: $ {{$formdata["travel_cost"]}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>: {{ ($formdata["benefits"] != '' ? $formdata["benefits"] : '-') }}</td>
                </tr>
                <tr>
                    <td>Business Unit Sponsoring</td>
                    <td>: {{ ($formdata["business"] != '' ? $formdata["business"] : '-') }}</td>
                </tr>
            </table>
        </td>
    </tr>
    <tr>
        <td>
            <a href="{{ url('approve_appliedconference', $formdata['link']) }}">Click this link to Approve</a>
            <a href="{{ url('reject_appliedconference', $formdata['link']) }}">Click this link to Reject</a>
        </td>
    </tr>
    <tr>
        <td>
