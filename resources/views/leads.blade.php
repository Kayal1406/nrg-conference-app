                    ...
                    <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body accordion-toggle panelhover">
                            <div class="pull-right btn-table">
                                @if($conference->status_sm == "Approved")
                                <a href="{{url('apply', $conference->id)}}" class="btn btn-md btn-info btn-hover-change">Request to Attend</a>
                                @endif
                            </div>
                            <div>
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse in">
                        <div class="panel-body accordion-toggle">
                            <div class="pull-right btn-table">
                                ...
                                @if($is_admin == 1 AND is_null($conf_score))
                                <a href="#sponsorship" data-count="{{$conference->leads_count}}" data-id="{{$conference->id}}" data-toggle="modal" class="btn btn-md btn-info btn-hover-change">Sponsorship Survey</a>
                                @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" value="{{$conference->id}}" id="conference_id" name="conference_id"/>
...
<div id="notesForm" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-md btn-pop btn-default" data-dismiss="modal">Cancel</button>
            {!! Form::submit('Submit',['class' => 'btn btn-md btn-pop btn-info pull-right']) !!}
            {!! Form::close() !!}  
        </div>
    </div>
  </div>
...
$(document).ready(function(){
    ...
    $('a[href="#leadsForm"]').on('click', function (ev) {
        ...
        //admincheck
        if ($('input#cookiemail').val() == "" && $('input#is_admin').val() != 1) {
